<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		...
		<form class="form-horizontal" action="<?php echo site_url('mahasiswa/tambah_proses');?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Alamat Tinggal/ Kost</label>
				<div class="col-sm-9">
				...
				<div class="well well-sm"> 
					<div class="form-group">
						<div class="col-sm-offset-10 col-sm-5">
							<a href="<?php echo site_url('mahasiswa');?>" class="btn btn-primary"> <i class="glyphicon glyphicon-backward"/></i> Kembali</a>
						</div>
					</div>
				</div>
			</div>

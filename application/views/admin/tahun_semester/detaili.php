			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table class="table table-hover table-responsive table-bordered">
							...
							<form class="form-horizontal" action="<?php echo site_url('tahun_semester/tambah_pertama');?>" method="post" enctype="multipart/form-data">
								<tr>
									<td colspan=4>
										<select required name="id_akun" class="form-control">
											...
											<?php
												...
												{
													echo "<option value='".$s['id_akun']."'> ".$s['id_akun']." - ".$s['nama']." - ".$s[jumlah]."</option>";
												}
											?>
										</select>
										...
										<input type="hidden" name="gelombang" value=<?php echo $gelombang; ?> readonly maxlength=100 class="form-control">

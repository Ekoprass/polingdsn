<div class="panel panel-info side-body">
	...
	<?php $id=$soal['id_soal'];?>
	<div class="card-body">
		<form class="form-horizontal" action="<?php echo site_url('soal/edit_proses/'.$id);?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input value="<?php echo $soal['soal'];?>" type="text" name="soal" maxlength=90 class="form-control">
				</div>
			</div>
			<div class="form-group">

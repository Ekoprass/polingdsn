<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-font"/></span> &nbsp <a href="<?php echo site_url('pertanyaan/nonaktif');?>"><strong>Pertanyaan Nonaktif</strong></a>&nbsp
	...
	<div class="well well-sm">
		<a href="<?php echo site_url('pertanyaan/nonaktif');?>" class="btn btn-primary"> Kembali</a>
		...
		<table class="table table-hover table-responsive table-bordered">
			...
			<tr>
				...
				<td width=150 align = "center">
						...
						<a href="<?php echo site_url('pertanyaan/aktifkan/'.$row->id_pertanyaan);?>"
							class='tooltipsku' 
							data-toggle='tooltip' 
							data-placement='top' 

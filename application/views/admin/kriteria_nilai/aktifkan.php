<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			...
			<span class="glyphicon glyphicon-file"/></span> &nbsp <a href="<?php echo site_url('kriteria_nilai/nonaktif');?>"><strong>nilai Nonaktif</strong></a>
		</h4>
    </div>
	...
	<div class="card-body">
		<form class="form-horizontal" action="<?php echo site_url('kriteria_nilai/aktifkan_proses/'.$id);?>" method="post" enctype="multipart/form-data">

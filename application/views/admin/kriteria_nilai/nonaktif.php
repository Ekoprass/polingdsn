<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-user"/></span> &nbsp <a href="<?php echo site_url('kriteria_nilai/nonaktif');?>"><strong>Kriteria Nilai Nonaktif</strong></a>
		</h4>
    </div>
	
	<!--bawah panel / tambah dan cari-->
	<div class="well well-sm">
		<a href="<?php echo site_url('kriteria_nilai');?>" class="btn btn-success"><i class="glyphicon glyphicon-star"></i> Lihat Data Aktif</a>
		<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('kriteria_nilai/carinon');?>" method="post">
			<div class="form-group">
				<label>Cari nilai </label>
		...
		<table class="table table-hover table-responsive table-bordered">
			...
			<tr>
				...
				<td width=150 align = "center">
						...
						<a disabled href="<?php echo site_url('kriteria_nilai/aktifkan/'.$row->id_kriteria_nilai);?>"
							class='tooltipsku' 
							data-toggle='tooltip' 
							data-placement='top' 

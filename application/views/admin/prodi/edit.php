<div class="panel panel-info side-body">
	...
	<form class="form-horizontal" action="<?php echo site_url('prodi/edit_proses/'.$id);?>" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input required value="<?php echo $prodi['nama_prodi'];?>" type="text" name="nama" maxlength=90 class="form-control">
			</div>
		</div>
		<div class="col-sm-20">

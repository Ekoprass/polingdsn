	...
	<div class="side-body">
		...
		<form class="form-horizontal" action="<?php echo site_url('mata_kuliah/aktifkan_proses/'.$id);?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input required disabled value="<?php echo $mata_kuliah['smt'];?>" type="text" name="smt" maxlength=100 class="form-control">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group well">
				...
				<a href="<?php echo site_url('mata_kuliah/nonaktif');?>" class="btn btn-default">Kembali</a>
			</div>
		</form>
	</div>
</div>
<div class="panel panel-info side-body">
	...
	<div class="card-body">
		<form class="form-horizontal" action="<?php echo site_url('kelas/hapus_proses/'.$id);?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
						<input required disabled value="<?php echo $kelas['status'];?>" type="text" name="status" class="form-control"  size="12" maxlength="20" >

<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-user"/></span> &nbsp <a href="<?php echo site_url('dashboard/profil/'.$id);?>"><strong><?php echo $tata_usaha['nama_tu'];?></strong></a> &nbsp
		...
		<div class="well well-lg">
			...
			<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('tata_usaha/editpass/'.$id);?>" method="post">
				<div class="form-group">
					...
					<input disabled required value="<?php echo $tata_usaha['username'];?>" type="text" name="username" class="form-control" size="12" maxlength="20" >

<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-book"/></span> &nbsp <a href="<?php echo site_url('mata_kuliah/nonaktif');?>"><strong>Mata Kuliah Nonaktif</strong></a>
		</h4>
    </div>
		...
		<table class="table table-hover table-responsive table-bordered">
			...
			<tr>
				...
				<td width=150 align = "center">
						<a href="<?php echo site_url('mata_kuliah/detailnon/'.$row->id_mk);?>"
							class='tooltipsku' 
							data-toggle='tooltip' 
							data-placement='top' 

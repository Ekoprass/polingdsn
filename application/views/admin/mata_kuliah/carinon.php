<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-book"></span> &nbsp <a href="<?php echo site_url('mata_kuliah/nonaktif');?>"><strong>Mata Kuliah Nonaktif</strong></a>&nbsp
	...
	<div class="well well-sm">
		<a href="<?php echo site_url('mata_kuliah/nonaktif');?>" class="btn btn-primary"><i class="glyphicon glyphicon-backward"></i> Kembali</a>
		<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('mata_kuliah/carinon');?>" method="post">

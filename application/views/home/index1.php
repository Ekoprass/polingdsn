							...
							<div class="login-body">
								<form action="<?php //echo site_url('home/proses');?>" method="post">
									...
									<div class="control">
										...
										<input type="text" class="form-control" placeholder="isikan username" required name="username"/>
									</div>
									<div class="control">
										<label>Password</label>
										<input type="password" class="form-control" placeholder="isikan password" required name="password"/>
									</div>
									<div class="login-button text-center">
